...
export const NavIcons = {
  ...
  settings: (
    <svg className={iconClassName} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8a4 4 0 100 8 4 4 0 000-8zm7 4a7 7 0 01-.2 1.7l2 1.5-2 3.4-2.4-1a7.1 7.1 0 01-2.4 1.4l-.3 2.6H9.3l-.3-2.6a7.1 7.1 0 01-2.4-1.4l-2.4 1-2-3.4 2-1.5A7 7 0 013 12c0-.6.1-1.1.2-1.7L1.2 8.8l2-3.4 2.4 1a7.1 7.1 0 012.4-1.4l.3-2.6h4.4l.3 2.6a7.1 7.1 0 012.4 1.4l2.4-1 2 3.4-2 1.5c.1.6.2 1.1.2 1.7z" />
    </svg>
  ),
  help: (
    <svg className={iconClassName} fill="none" stroke="currentColor" viewBox="0 0 24 24">
